  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'هاست‌ها', link: '/fa/docs/hosts' },        
        { text: 'گروه‌ها', link: '/fa/docs/groups' },        
        { text: 'قالب‌ها', link: '/fa/docs/templates' },
        { text: 'مرزبان نود ✨', link: '/fa/docs/marzban-node' },   
        { text: 'هسته‌ها', link: '/fa/docs/cores' },    
        { text: 'لاگ‌ها', link: '/fa/docs/logs' },                  
        { text: 'ادمین‌ها', link: '/fa/docs/admins' },  
        { text: 'تنظیمات', link: '/fa/docs/settings' },                            
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'بک‌آپ گرفتن و بازگردانی', link: '/fa/examples/backup' },        
