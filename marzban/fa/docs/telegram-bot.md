...
اگر قصد دارید که لاگ های پنل جدا باشد یک کانال ایجاد کنید در آن یک متن بفرستید و متن  برای ربات فوروارد کنید درخروجی ایدی کانال دریافت میکنیم . ربات باید عضو کانال وادمین باشد 
