...
- درباره سیستم.
- ریستارت xray.
- ویرایش تکی یوزر ( حذف کردن، غیر فعال کردن،دریافت لینک ساب،تغییر لینک ساب، اضافه کردن حجم،  بازنشانی حجم استفاده شده، ویرایش یادداشت).
  
- ویرایش دسته جمعی یوزرها (اضافه کردن حجم، تاریخ، حذف اینباند، اضافه کردن اینباند، حذف یوزرهای اتمام حجم ، حذف یوزرهای اتمام تاریخ ).
