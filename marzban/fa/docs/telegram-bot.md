...
- در خروجی پیامی حاوی Your ID  دریافت میکنیم.
- این مقدار را یادداشت کنیم و به تنظیمات بعدی برویم.
...
- برای این کار باید متغیرهای مربوطه را در  فایل  .env با برداشتن کامنت  `#` یا  اضافه کردن آنها به انتهای فایل و تخصیص مقادیر به دست آمده قبلی در فایل تنظیم کنیم.

  
| متغیر                    |  معنی  |
|----------------:|-----------:|
| `TELEGRAM_API_TOKEN`           | توکن ربات تلگرام|       
| `TELEGRAM_ADMIN_ID`|آیدی عددی ادمین در تلگرام.شناسه ادمین الزامی است ، اگر نیاز به دسترسی به چندین ادمین دارید، آیدی آنها را مشخص کنید و با کاما `,`از هم جدا کنید|
