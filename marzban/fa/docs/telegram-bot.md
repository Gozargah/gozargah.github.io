...
1 - درباره سیستم
2 - ریستارت xray
3 - ویرایش یوزر ( حذف کردن، غیر فعال کردن،تغییر لینک ساب، اضافه کردن حجم، ویرایش یادداشت ، بازنشانی حجم استفاده شده.)
4 - ویرایش دسته جمعی یوزرها (اضافه کردن حجم، تاریخ، حذف اینباند، اضافه کردن اینباند، حذف یوزرهای اتمام حجم ، حذف یوزرهای اتمام تاریخ )
...
-1 علاوه بر این، برای تعامل با پنل مرزبان، مدیریت آن و دریافت اطلاعیه های مهم سیستم، می توانید ربات تلگرام ادمین را فعال کنید.
